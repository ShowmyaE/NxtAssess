...
const Results = ({history}) => {
  ...
  const imageToUse =
    time === 0
      ? 'https://res.cloudinary.com/ddx1atlse/image/upload/v1720508973/ResultNotIntime_wd9uch.png'
      : 'https://res.cloudinary.com/ddx1atlse/image/upload/v1720508973/ResultInTime_conu6l.png'
